...
class ProfileViewController: UIViewController {
    ...
    private let pointsView = InfoBoxView(iconName: "points_icon", title: "POINTS", value: "590")
    private let rankView = InfoBoxView(iconName: "rank_icon", title: "RANK", value: "#56")
    ...
    private func setupLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            infoBoxContainerView.topAnchor.constraint(equalTo: profileHeaderView.bottomAnchor, constant: 20),
            infoBoxContainerView.leadingAnchor.constraint(equalTo: whiteContainerView.leadingAnchor, constant: 16),
            infoBoxContainerView.trailingAnchor.constraint(equalTo: whiteContainerView.trailingAnchor, constant: -16),
            infoBoxContainerView.heightAnchor.constraint(equalToConstant: 100),
            
            infoBoxStackView.topAnchor.constraint(equalTo: infoBoxContainerView.topAnchor, constant: 12),
            infoBoxStackView.bottomAnchor.constraint(equalTo: infoBoxContainerView.bottomAnchor, constant: -12),
            infoBoxStackView.leadingAnchor.constraint(equalTo: infoBoxContainerView.leadingAnchor, constant: 12),
            infoBoxStackView.trailingAnchor.constraint(equalTo: infoBoxContainerView.trailingAnchor, constant: -12),
