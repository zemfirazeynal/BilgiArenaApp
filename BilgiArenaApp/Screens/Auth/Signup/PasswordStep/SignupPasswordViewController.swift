...
//            label.font = .systemFont(ofSize: 16)
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        passwordTextField.focus() // bu, klaviaturanı göstərir
    }
        ...
        private func setupLayout() {
            ...
            [navigationHeader, titleLabel, passwordLabel, passwordTextField , ruleLabel, checkmarkImageView, progressLabel, progressView, nextButton].forEach {
                view.addSubview($0)
            }
            ...
            NSLayoutConstraint.activate([
                ...
                passwordLabel.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 40),
                ...
                ruleLabel.topAnchor.constraint(equalTo: passwordTextField.bottomAnchor, constant: 8),
                    ruleLabel.leadingAnchor.constraint(equalTo: passwordTextField.leadingAnchor),
                ...
                progressLabel.topAnchor.constraint(equalTo: checkmarkImageView.bottomAnchor, constant: 12),
                progressLabel.trailingAnchor.constraint(equalTo: passwordTextField.trailingAnchor),

                progressView.topAnchor.constraint(equalTo: progressLabel.bottomAnchor, constant: 8),
                progressView.leadingAnchor.constraint(equalTo: passwordTextField.leadingAnchor),
                progressView.trailingAnchor.constraint(equalTo: passwordTextField.trailingAnchor),
