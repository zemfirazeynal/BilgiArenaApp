...
class QuizStartViewController: UIViewController {
    ...
    private func configureLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            questionNumberLabel.topAnchor.constraint(
                equalTo: whiteContentView.topAnchor,
                constant: 24
            ),
            questionNumberLabel.leadingAnchor.constraint(
                equalTo: whiteContentView.leadingAnchor,
                constant: 24
            ),

            questionLabel.topAnchor.constraint(
                equalTo: questionNumberLabel.bottomAnchor,
                constant: 12
            ),
            questionLabel.leadingAnchor.constraint(
                equalTo: questionNumberLabel.leadingAnchor
            ),
    ...
    // MARK: - Helpers
    private func addOptionButtons(below anchor: NSLayoutYAxisAnchor)
        -> NSLayoutYAxisAnchor
    {
    ...
    private func configureQuestionText(_ text: String) {
        ...
        questionLabel.attributedText = NSAttributedString(
            string: text,
