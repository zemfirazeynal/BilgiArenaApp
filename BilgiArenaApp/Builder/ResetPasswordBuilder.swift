...
struct ResetPasswordBuilder {
    static func build(coordinator: ResetPasswordCoordinatorProtocol)
        -> UIViewController
    {
    ...
    static func buildOtpCode(coordinator: ResetPasswordCoordinatorProtocol)
        -> UIViewController
    {
    ...
    static func buildNewPassword(coordinator: ResetPasswordCoordinatorProtocol)
        -> UIViewController
    {
